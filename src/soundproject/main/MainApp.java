...
public class MainApp {
    ...
    private static AudioData audio;
    ...
    public static void main(String[] args) {
        ...
        loadItem.addActionListener(e -> {
            ...
            FFTProcessor fft = new FFTProcessor(audio);

            tabs.setComponentAt(0, new AmplitudePanel(new AmplitudeAnalyzer(audio)));
            tabs.setComponentAt(1, new FFTPanel(audio));

            PowerSpectrum spectrum = new PowerSpectrum(fft);
            tabs.setComponentAt(2, new SpectrumPanel(spectrum));

            tabs.setComponentAt(3, new FilterView(audio));
            tabs.setComponentAt(4, new BeatPanel(audio));

            infoArea.setText("");
            infoArea.append("File: " + file.getName() + "\n");
            infoArea.append("Sample Rate: " + audio.sampleRate + " Hz\n");
            infoArea.append("Channels: " + audio.numChannels + "\n");
            infoArea.append("Duration: " +
                    String.format("%.2f", audio.getDurationSeconds()) + " sec\n");
